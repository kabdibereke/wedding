import {
  ...
  ɵlazySDKProxy,
  ɵzoneWrap
} from "./chunk-NWG7RAVB.js";
import "./chunk-6ZXYWAPH.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
} from "./chunk-GUUS7DBO.js";
import {
  isPlatformServer
} from "./chunk-NNHPYDMS.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name4, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-S33GREGX.js"))), map(() => ɵfirebaseAppFactory(options, zone, name4)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
